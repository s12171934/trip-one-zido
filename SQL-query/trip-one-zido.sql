...
ALTER TABLE `member` ADD CONSTRAINT `FK_security_questions_TO_member_1` FOREIGN KEY (
	`question`
)
...
ALTER TABLE `plan_spot` ADD CONSTRAINT `FK_plan_spot_TO_plan_1` FOREIGN KEY (
	`plan_id`
)
REFERENCES `plan` (
	`id`
...
ALTER TABLE `plan_spot` ADD CONSTRAINT `FK_plan_spot_TO_spot_1` FOREIGN KEY (
	`spot_id`
)
REFERENCES `spot` (
	`id`
...
ALTER TABLE `pin` ADD CONSTRAINT `FK_member_TO_pin_1` FOREIGN KEY (
	`member_id`
)
REFERENCES `member` (
	`id`
...
ALTER TABLE `pin` ADD CONSTRAINT `FK_content_TO_pin_1` FOREIGN KEY (
	`content_id`
)
REFERENCES `content` (
	`id`
